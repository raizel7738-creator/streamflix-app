        ...
        >
            <div className="banner_contents">
                ...
                <div className="banner_buttons">
                    <button className="banner_button play_button" aria-label="Play">
                        <svg 
                            width="24" 
                            height="24" 
                            viewBox="0 0 24 24" 
                    ...
                    <button className="banner_button info_button" aria-label="More Info">
                        <svg 
                            width="24" 
                            height="24" 
                            viewBox="0 0 24 24" 
